...
<div id="addModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form method="post" action="Insert_rec.php">
				...
				<div class="modal-body">					
					...
					<div class="form-group">
						...
						<input type="text" name="Tout" class="form-control" required>
					</div>	
...
<?php foreach($recs as $rec): ?>				
					<tr>
						...
						<td><?=$rec->time_out?></td>
						<td>
							<a href="UpdateSee.php?id=<?= $rec->id ?>" class="edit"><i class="material-icons"  title="Edit">&#xE254;</i></a>
							<a href="delete_rec.php?id=<?= $rec->id?>"  class="delete"><i class="material-icons" title="Delete">&#xE872;</i></a>
						</td>
					</tr>
					<?php endforeach; ?>
			</tbody>
